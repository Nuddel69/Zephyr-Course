...
<Tabs>
  <TabItem value="linux" label="Nucleo H753ZI">
    `nucleo_h753zi.overlay`
  </TabItem>
  <TabItem value="windows" label="Nucleo H755ZI">
    `nucleo_h755zi_q_stm32h755x_m7.overlay`
  </TabItem>
</Tabs>

This file will override the global board, and
...
west build --board nucleo_h753zi Blinky -- -DDTC_OVERLAY_FILE=boards/nucleo_h753zi.overlay
  ...
  <TabItem value="windows" label="Nucleo H755ZI">
    ```
west build --board nucleo_h755zi_q/stm32h755xx/m7 Blinky -- -DDTC_OVERLAY_FILE=boards/nucleo_h755zi_q_stm32h755xx_m7.overlay
    ```
  </TabItem>
</Tabs>
---
