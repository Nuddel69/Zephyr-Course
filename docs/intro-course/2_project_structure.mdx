...
:::info[Intermission - Your First Application]
...
:::info[Intermission - Exporting the Custom CMake Commands]
...
:::info[Intermission - Creating the Application CMake Definition]
